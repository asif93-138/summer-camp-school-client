...
const Footer = () => {
    return (
        ...
        <Link className="navbar-brand" to="/"><h3 className="m-0 border-end border-white p-3 px-sm-5 py-sm-4 f-b"><b>COLLEGE OF MAGIC</b></h3></Link>
       ...
       <p className="text-center">
        ...
        <p className='m-0 text-center'>COLLEGE OF MAGIC, Dhaka, BD.</p>
